...
import com.github.perftool.redis.spring.AbstractThread;
...
@Slf4j
public class RedisThread extends AbstractThread {

    private final RedisTemplate<String, Object> redisTemplate;
    private final RedisConfig redisConfig;

    public RedisThread(List<String> ids, MetricFactory metricFactory,
