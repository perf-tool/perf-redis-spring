...
public abstract class AbstractThread extends Thread {
    ...
    public AbstractThread(RedisConfig redisConfig, MetricFactory metricFactory, List<String> initIds) {
        this.redisConfig = redisConfig;
        this.rateLimiter = RateLimiter.create(redisConfig.threadRateLimit);
    ...
    public void run() {
        while (true) {
            if (rateLimiter.tryAcquire(redisConfig.threadRateLimitTimeoutMs, TimeUnit.MILLISECONDS)) {
                try {
